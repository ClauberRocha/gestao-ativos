...
import { ArrowDownToLine, ArrowRight, Boxes, Check, ChevronLeft, ChevronRight, CircleAlert, Database, LayoutDashboard, Loader2, LockKeyhole, LogIn, MapPin, PackageCheck, Plus, Search, ShieldCheck, SlidersHorizontal, Sparkles, Trash2, UserRound, Users, X } from "lucide-react";
...
export default function Home() {
  ...
  }, [page, pageSize, query, status, conservacao, contaCliente, createdFrom, createdTo, modifiedFrom, modifiedTo, user]);
